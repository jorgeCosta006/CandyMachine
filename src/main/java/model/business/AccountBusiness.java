...
/**
 * Business responsável por comunicar com daos referentes a conta: criar user,
 * alterar user, procurar user por email e password, machine por nome, e lista de roles;
 */
